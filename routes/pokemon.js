...
// GET /pokemon/:id - render a page with info about the selected Pokemon
router.get('/:name', async (req, res) => {
  let response = await axios.get(`https://pokeapi.co/api/v2/pokemon/${req.params.name}`);
  res.render('pokemon/show', { info: response.data });
});

// DELETE /pokemon/:id - receive the name of a Pokemon and delete it from the database
